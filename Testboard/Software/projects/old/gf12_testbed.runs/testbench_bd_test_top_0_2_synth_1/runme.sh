...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/gf12_testbed.runs/testbench_bd_test_top_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_bd_test_top_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_bd_test_top_0_2.tcl
