...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/projects/zybo/zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testbench_bd_wrapper.tcl -notrace
