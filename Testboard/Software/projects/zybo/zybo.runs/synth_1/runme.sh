...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/projects/zybo/zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_bd_wrapper.tcl
