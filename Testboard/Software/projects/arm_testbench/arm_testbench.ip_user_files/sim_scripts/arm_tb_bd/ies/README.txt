...
#
# Generated by export_simulation on Thu Jun 03 15:25:48 -0600 2021
#
################################################################################
...
'-reset_run' switch to the './arm_tb_bd.sh' script.

./arm_tb_bd.sh -reset_run
...
./arm_tb_bd.sh -noclean_files

For more information on the script, please type './arm_tb_bd.sh -help'.
