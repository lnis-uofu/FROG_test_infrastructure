...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/projects/blinky/blinky.runs/blinky_bd_test_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_bd_test_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_bd_test_top_0_0.tcl
