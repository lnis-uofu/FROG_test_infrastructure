...
module design_1
  ...
  input GPIO23_pad;
  input GPIO2_pad;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.GPIO3_PAD DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.GPIO3_PAD, LAYERED_METADATA undef" *) input GPIO3_pad;
  input GPIO6_pad;
  input GPIO7_pad;
  input GPIO8_pad;
  input GPIO9_pad;
  ...
  wire SC_TAIL_pad_1;
  wire scan_chain_freq_test_0_CCFF_HEAD_pad;
  wire scan_chain_freq_test_0_CLK_pad;
  wire scan_chain_freq_test_0_PRESET_pad;
  wire scan_chain_freq_test_0_PROG_CLK_pad;
  wire scan_chain_freq_test_0_RESET_pad;
  wire scan_chain_freq_test_0_SC_HEAD_pad;
  wire scan_chain_freq_test_0_TEST_EN_pad;
  wire scan_chain_freq_test_0_t0_is_output;
  wire scan_chain_freq_test_0_t0_pad;
  wire scan_chain_freq_test_0_t1_is_output;
  wire scan_chain_freq_test_0_t1_pad;
  wire scan_chain_freq_test_0_t2_is_output;
  wire scan_chain_freq_test_0_t2_pad;
  wire scan_chain_freq_test_0_t3_is_output;
  wire t3_pad_1;
  wire zynq_ultra_ps_e_0_pl_clk0;

  assign CCFF_HEAD_pad = scan_chain_freq_test_0_CCFF_HEAD_pad;
  ...
  assign CLK_pad = scan_chain_freq_test_0_CLK_pad;
  ...
  assign PRESET_pad = scan_chain_freq_test_0_PRESET_pad;
  assign PROG_CLK_pad = scan_chain_freq_test_0_PROG_CLK_pad;
  assign RESET_pad = scan_chain_freq_test_0_RESET_pad;
  assign SC_HEAD_pad = scan_chain_freq_test_0_SC_HEAD_pad;
  assign SC_TAIL_pad_1 = SC_TAIL_pad;
  assign TEST_EN_pad = scan_chain_freq_test_0_TEST_EN_pad;
  assign t0_is_output = scan_chain_freq_test_0_t0_is_output;
  assign t0_pad = scan_chain_freq_test_0_t0_pad;
  assign t1_is_output = scan_chain_freq_test_0_t1_is_output;
  assign t1_pad = scan_chain_freq_test_0_t1_pad;
  assign t2_is_output = scan_chain_freq_test_0_t2_is_output;
  assign t2_pad = scan_chain_freq_test_0_t2_pad;
  assign t3_is_output = scan_chain_freq_test_0_t3_is_output;
  assign t3_pad_1 = t3_pad;
  design_1_scan_chain_freq_test_0_0 scan_chain_freq_test_0
       (.CCFF_HEAD_pad(scan_chain_freq_test_0_CCFF_HEAD_pad),
        ...
        .CLK_pad(scan_chain_freq_test_0_CLK_pad),
        ...
        .PRESET_pad(scan_chain_freq_test_0_PRESET_pad),
        .PROG_CLK_pad(scan_chain_freq_test_0_PROG_CLK_pad),
        .RESET_pad(scan_chain_freq_test_0_RESET_pad),
        .SC_HEAD_pad(scan_chain_freq_test_0_SC_HEAD_pad),
        .SC_TAIL_pad(SC_TAIL_pad_1),
        .TEST_EN_pad(scan_chain_freq_test_0_TEST_EN_pad),
        .sys_clk(zynq_ultra_ps_e_0_pl_clk0),
        .t0_is_output(scan_chain_freq_test_0_t0_is_output),
        .t0_pad(scan_chain_freq_test_0_t0_pad),
        .t1_is_output(scan_chain_freq_test_0_t1_is_output),
        .t1_pad(scan_chain_freq_test_0_t1_pad),
        .t2_is_output(scan_chain_freq_test_0_t2_is_output),
        .t2_pad(scan_chain_freq_test_0_t2_pad),
        .t3_is_output(scan_chain_freq_test_0_t3_is_output),
        .t3_pad(t3_pad_1));
