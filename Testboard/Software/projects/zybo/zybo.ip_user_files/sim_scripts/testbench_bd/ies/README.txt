...
#
# Generated by export_simulation on Thu May 20 13:35:45 -0600 2021
#
################################################################################
...
'-reset_run' switch to the './testbench_bd.sh' script.

./testbench_bd.sh -reset_run
...
./testbench_bd.sh -noclean_files

For more information on the script, please type './testbench_bd.sh -help'.
