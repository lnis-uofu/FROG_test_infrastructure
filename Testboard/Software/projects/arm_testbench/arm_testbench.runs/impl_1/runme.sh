...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/projects/arm_testbench/arm_testbench.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_tb_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arm_tb_bd_wrapper.tcl -notrace
