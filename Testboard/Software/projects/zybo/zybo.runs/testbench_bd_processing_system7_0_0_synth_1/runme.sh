...
HD_PWD='C:/Users/apond/Documents/zybo/zybo.runs/testbench_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_bd_processing_system7_0_0.tcl
