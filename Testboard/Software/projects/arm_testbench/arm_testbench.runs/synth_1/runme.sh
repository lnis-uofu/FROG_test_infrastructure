...
HD_PWD='C:/Users/lnis/Documents/GF12_Testbed/projects/arm_testbench/arm_testbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_tb_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_tb_bd_wrapper.tcl
